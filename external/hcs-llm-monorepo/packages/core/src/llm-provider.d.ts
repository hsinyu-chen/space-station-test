 ...
 */
export declare const DEFAULT_PROVIDER_ID = "gemini";
...
export interface LLMProvider {
    ...
    generateContentStream(config: LLMProviderConfig, contents: LLMContent[], systemInstruction: string, genConfig: LLMGenerateConfig): AsyncIterable<LLMStreamChunk>;
