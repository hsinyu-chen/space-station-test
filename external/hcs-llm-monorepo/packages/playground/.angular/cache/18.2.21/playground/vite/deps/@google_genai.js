...
var Files = class extends BaseModule {
   ...
   */
  registerFiles(params) {
    return __async(this, null, function* () {
      throw new Error("registerFiles is only supported in Node.js environments.");
    });
  }
  _registerFiles(params) {
    return __async(this, null, function* () {
...
var ApiClient = class {
  ...
  apiCall(url, requestInit) {
    return __async(this, null, function* () {
      ...
      const runFetch = () => __async(this, null, function* () {
...
var Models = class extends BaseModule {
  constructor(apiClient) {
    super();
    this.apiClient = apiClient;
    this.embedContent = (params) => __async(this, null, function* () {
      if (!this.apiClient.isVertexAI()) {
        ...
        return yield this.embedContentInternal(params);
      }
      ...
      if (isVertexEmbedContentModel) {
        ...
        return yield this.embedContentInternal(paramsPrivate);
      } else {
        const paramsPrivate = Object.assign(Object.assign({}, params), {
  ...
  processParamsMaybeAddMcpUsage(params) {
    return __async(this, null, function* () {
      ...
      const transformedTools = yield Promise.all(tools.map((tool) => __async(this, null, function* () {
        if (isCallableTool(tool)) {
          const callableTool = tool;
...
var BaseWebhooks = class extends APIResource {
  ...
  create(params, options) {
    const {
      api_version = this._client.apiVersion,
      webhook_id
    } = params, body = __rest(params, ["api_version", "webhook_id"]);
  ...
  update(id, params, options) {
    const {
      api_version = this._client.apiVersion,
      update_mask
    } = params, body = __rest(params, ["api_version", "update_mask"]);
  ...
  list(params = {}, options) {
    const _a2 = params !== null && params !== void 0 ? params : {}, {
      api_version = this._client.apiVersion
    } = _a2, query = __rest(_a2, ["api_version"]);
  ...
  rotateSigningSecret(id, params = {}, options) {
    const _a2 = params !== null && params !== void 0 ? params : {}, {
      api_version = this._client.apiVersion
    } = _a2, body = __rest(_a2, ["api_version"]);
...
function defaultParseResponse(client, props) {
  return __async(this, null, function* () {
    ...
    const body = yield (() => __async(this, null, function* () {
      var _a2;
...
var BaseGeminiNextGenAPIClient = class _BaseGeminiNextGenAPIClient {
  ...
  makeRequest(optionsInput, retriesRemaining, retryOfRequestLogID) {
    return __async(this, null, function* () {
      ...
      const {
        ...
        url,
        timeout
      } = yield this.buildRequest(options, {
  ...
  buildRequest(_0) {
    return __async(this, arguments, function* (inputOptions, {
      retryCount = 0
    } = {}) {
      var _b, _c, _d;
      ...
      const reqHeaders = yield this.buildHeaders({
  ...
  buildHeaders(_0) {
    return __async(this, arguments, function* ({
      ...
      let headers = buildHeaders([idempotencyHeaders, {
        Accept: "application/json",
        "User-Agent": this.getUserAgent()
      }, this._options.defaultHeaders, bodyHeaders, options.headers, authHeaders]);
...
function uploadBlob(file, uploadUrl, apiClient, httpOptions) {
  return __async(this, null, function* () {
    var _a2;
    const response = yield uploadBlobInternal(file, uploadUrl, apiClient, httpOptions);
...
function uploadBlobToFileSearchStore(file, uploadUrl, apiClient, httpOptions) {
  return __async(this, null, function* () {
    var _a2;
    const response = yield uploadBlobInternal(file, uploadUrl, apiClient, httpOptions);
    const responseJson = yield response === null || response === void 0 ? void 0 : response.json();
...
function uploadBlobInternal(file, uploadUrl, apiClient, httpOptions) {
  return __async(this, null, function* () {
    var _a2, _b, _c;
...
var BrowserUploader = class {
  upload(file, uploadUrl, apiClient, httpOptions) {
    return __async(this, null, function* () {
      if (typeof file === "string") {
        throw new Error("File path is not supported in browser uploader.");
      }
      return yield uploadBlob(file, uploadUrl, apiClient, httpOptions);
    });
  }
  uploadToFileSearchStore(file, uploadUrl, apiClient, httpOptions) {
    return __async(this, null, function* () {
      if (typeof file === "string") {
        throw new Error("File path is not supported in browser uploader.");
      }
      return yield uploadBlobToFileSearchStore(file, uploadUrl, apiClient, httpOptions);
    });
  }
  stat(file) {
    return __async(this, null, function* () {
